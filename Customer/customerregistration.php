...
if(isset($_POST['id']) ){
    ...
    if($rows['id']== true){
      ...
      $sql ="INSERT INTO `customer_details` (`id`, `name`, `color`, `family_count`, `contact`, `city`,`password`) VALUES('$id', '$name', '$color', '$family_count','$contact', '$city','$password');";
...
<body>
    ...
    ?>
        ...
        <button onClick = "gotoLogin()" style = "background: #3498db">Go to Login Form</button>
    </div>
      <script>
        const gotoLogin = ()=>{
